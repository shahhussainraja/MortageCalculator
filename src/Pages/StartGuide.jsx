    ...
    <div className="h-screen flex justify-center ">
        ...
        <div className='h-[80%] w-[75%] rounded-2xl mt-10 flex bg-[#fcfcfc]'>
            <div className='flex-[.6] flex items-start justify-center flex-col px-8 space-y-2'>
                <p className='font-OpenSansRegular font-extrabold text-lg lg:text-3xl text-[#006875] '>Home Loan Borrowing Power Calculator!<br></br></p>
            ...
            <div className='flex-[.4] rounded-xl guideImage'>
                {/* imge Container */}
            </div>
